        ...
        return (
            ...
            >
                <div className="flex items-center space-x-3">
                    <a
                        href="/"
                        className={ ` flex items-center space-x-2 text-xl font-bold pointer ` }
                    >
                        <Image
            ...
            <div className="relative flex items-center gap-4">
                ...
                { dropdownOpen && !profileLoading && (
                    <motion.div
                        ...
                        animate={ { opacity: 1, y: 0 } }
                        exit={ { opacity: 0, y: -8 } }
                        className="absolute right-0 top-60 mt-2 w-44 bg-gray-800 border border-gray-700 rounded shadow-lg z-10"
                    >
