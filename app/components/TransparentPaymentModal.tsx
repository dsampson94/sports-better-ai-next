        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-60 z-50">
            <div className="bg-white text-gray-900 rounded-lg p-8 w-full max-w-md">
                ...
                <p className="mb-4 text-sm text-gray-600">
                    Your payment is securely processed by <strong>PayFast</strong>, a trusted payment provider.
                </p>
                <div className="mb-4">
                ...
                >
                    { loading
                        ? 'Processing...'
                        : `Pay $${ plan.price } for ${ selectedPlan.charAt(0).toUpperCase() + selectedPlan.slice(1) } Plan` }
                </button>
